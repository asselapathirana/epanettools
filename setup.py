...
cargs=['-I'+"epanettools"+os.sep+"epanet",'-Wno-implicit-function-declaration','-Wno-unused-but-set-variable','-Wno-format','-Wno-char-subscripts', '-fopenmp','-Wno-deprecated','-O3']
...
setup (name = NAME,
	   ...
	   ext_modules = [epanet2_module], #, xxxx_module],
