...
# since that may mess with compiling dependencies (e.g. numpy).
# Therefore we set SETUPPY_CFLAGS=-coverage in tox.ini and copy it to CFLAGS
# here (after deps have been safely installed).
